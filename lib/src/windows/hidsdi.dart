...
class HidSdi {
  ...
  late final _HidD_GetAttributesPtr = _lookup<
      ffi.NativeFunction<
          BOOLEAN Function(
              win32_types.HANDLE, PHIDD_ATTRIBUTES)>>('HidD_GetAttributes');
  late final _HidD_GetAttributes =
      _HidD_GetAttributesPtr.asFunction<int Function(int, PHIDD_ATTRIBUTES)>();
  ...
  late final _HidD_GetPreparsedDataPtr = _lookup<
      ffi.NativeFunction<
          BOOLEAN Function(win32_types.HANDLE,
  ...
  late final _HidD_GetPreparsedData = _HidD_GetPreparsedDataPtr.asFunction<
      int Function(int, ffi.Pointer<PHIDP_PREPARSED_DATA>)>();
...
typedef USHORT = pkg_ffi.UnsignedShort;
